...
import com.example.carease.R.drawable.*
...
class ProductAdapter(private val productList: ArrayList<Product>, context: Context): RecyclerView.Adapter<ProductAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Log.d("AdapterBinding", "Binding product: ${product.productName}") // Add this
    ...
    init {
        Log.d("ProductAdapterInit", "Adapter initialized with ${productList.size} products")
    }
}