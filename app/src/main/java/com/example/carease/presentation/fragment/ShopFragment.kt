...
import com.example.carease.data.model.Category
import com.example.carease.data.model.Product
import com.example.carease.presentation.adapter.CategoryAdapter
...
class ShopFragment : Fragment() {
    ...
    private fun setupRecyclerViews(view: View) {
        ...
        // Setup Cover Products RecyclerView
        coverRecViewShopFrag.apply {
    ...
    private fun setCategoryData() {
        ...
        Log.d("CategoryData", "Category List Size: ${cateList.size}")
    ...
    private fun setCoverData() {
        ...
        Log.d("CoverProductData", "Cover Product List: $coverD")
